...
class __Mustache_222010380d9f562733da209d4ece87a2 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $indent . '     ';
            // 'ccn_context_course' section
            $value = $context->find('ccn_context_course');
            $buffer .= $this->sectionA71975f80ea07e3240b90faf07c1b68f($context, $indent, $value);
            $buffer .= '
';
            $buffer .= $indent . '   ';
        }
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->sectionD708abb082932ffab0d3b96c2affe225($context, $indent, $value);
        }
        $buffer .= $indent . '
';
        $buffer .= $indent . '
';
        // 'hascontrols' section
        $value = $context->find('hascontrols');
        $buffer .= $this->section8a8d864bc7577fe49f9df886821acb95($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionA71975f80ea07e3240b90faf07c1b68f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' blog_tag_widget ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
...
';
    ...
    private function sectionD708abb082932ffab0d3b96c2affe225(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
    <h4 id="instance-{{blockinstanceid}}-header" class="title">{{{title}}}</h4>
  ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
...
';
    ...
    private function sectionE99afc5bc921f11e761db2bcf6b0f1e8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="ccnBlockControls--lc-vb">
          <a class="ccnBlockControls--lc-vb--btn" href="{{{ccn_lc_vb}}}"><span class="ccn-flaticon-magic-wand"></span> {{#str}} live_customizer, theme_edumy {{/str}}</a>
        </div>
      ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
...
';
                ...
                $buffer .= $value;
                $buffer .= '"><span class="ccn-flaticon-magic-wand"></span> ';
                // 'str' section
                $value = $context->find('str');
...
';
    ...
    private function section8a8d864bc7577fe49f9df886821acb95(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionE99afc5bc921f11e761db2bcf6b0f1e8($context, $indent, $value);
