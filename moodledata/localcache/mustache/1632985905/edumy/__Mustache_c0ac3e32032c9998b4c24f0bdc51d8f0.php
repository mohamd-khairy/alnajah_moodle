...
class __Mustache_c0ac3e32032c9998b4c24f0bdc51d8f0 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="mb-2 hidden" data-region="delete-messages-for-all-users-toggle-container">
';
        $buffer .= $indent . '        <label class="custom-control-label ml-2 text-muted">
';
        $buffer .= $indent . '            <input type="checkbox" data-region="delete-messages-for-all-users-toggle">
';
        $buffer .= $indent . '            ';
        // 'str' section
