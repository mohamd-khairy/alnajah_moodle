...
/**
 * Strings for component 'qtype_combined', language 'ar', version '3.10'.
 *
...
أنظر <a href="https://moodle.org/plugins/view.php?plugin=qtype_combined">االإدخال المتعلق بوضع الملاحق في قاعدة البيانات</a> للمزيد من التفاصيل مع قائمة بأنواع الأسئلة التي يمكن استعمالها كأسئلة فرعية.';
