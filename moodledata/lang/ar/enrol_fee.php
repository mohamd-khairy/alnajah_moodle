...
/**
 * Strings for component 'enrol_fee', language 'ar', version '3.10'.
 *
 * @package     enrol_fee
 * @category    string
...
$string['fee:unenrol'] = 'إلغاء انضمام المستخدمين إلى المقرر الدراسي';
$string['fee:unenrolself'] = 'إلغاء انضمامه إلى المقرر الدراسي';
$string['nocost'] = 'ليست هناك تكلفة عند الانضمام إلى هذا المقرر الدراسي!';
