...
/**
 * Strings for component 'cachestore_apcu', language 'ar', version '3.10'.
 *
...
$string['privacy:metadata'] = 'يخزن ملحق خبء المستخدم APC (APCu) البيانات لفترة وجيزة كجزء من وظيفة التخزين المؤقت ولكن يتم مسح هذه البيانات بانتظام ولا يتم إرسالها خارجياً بأيّ طريقة.';
