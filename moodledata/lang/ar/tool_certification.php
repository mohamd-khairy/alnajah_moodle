...
/**
 * Strings for component 'tool_certification', language 'ar', version '3.10'.
 *
...
$string['allocationwindowendedon'] = 'النافذة الزمنية لهذه الشهادة قد انتهت في {$a}.';
$string['allocationwindowstartdate'] = 'تاريخ البداية';
$string['allocationwindowstartdate_help'] = 'تاريخ البداية لتخصيص الإطار';
$string['allocationwindowstartson'] = 'النافذة الزمنية لهذه الشهادة قد بدأت في {$a}.';
...
$string['autocreategroups_help'] = 'عندما يتم ضم المستخدمين إلى مقررات البرنامج، يمكن إضافتهم تلقائياً إلى نفس المجموعة. في حالة اختيار "لهذه الشهادة"، سيتم استعمال مجموعة منفصلة لهذه الشهادة وستختلف عن الشهادات الأخرى التي تستعمل نفس البرنامج.';
...
$string['certification:edit'] = 'صلاحية التحرير';
$string['certification:view'] = 'صلاحية المعاينة';
...
$string['errorcantdeletenotarchivedcertification'] = 'لا يمكن إلغاء الشهادة غير المؤرشفة';
...
$string['errornopermissionallocateusers'] = 'لا صلاحية لتعيين المستخدمين للشهادة';
$string['errornopermissionmanagecertifications'] = 'لا صلاحية لإدارة الشهادات';
$string['errornopermissionviewallocatedusers'] = 'ليست لديك صلاحية معاينة المستخدمين المعينين في الشهادة';
...
$string['eventcertificationcompleted'] = 'شهادة تم إكمالها';
$string['eventcertificationcreated'] = 'شهادة تم إنشاؤها';
$string['eventcertificationdeleted'] = 'شهادة تم إلغاؤها';
$string['eventcertificationupdated'] = 'شهادة تم تحديثها';
$string['eventrecertificationgraceperiodended'] = 'فترة إعادة منح شهادة قد انتهت';
$string['eventrecertificationstarted'] = 'إعادة منح شهادة تم بدؤه';
$string['eventuserallocated'] = 'مستخدم تم تعيينه لشهادة';
$string['eventuserdeallocated'] = 'مستخدم تم إلغاء تعيينه';
$string['eventuserupdated'] = 'تعيين مستخدم تم تحديثه';
...
$string['export_content_help'] = 'الشهادات، الأسماء، الأوصاف، التواريخ، الوسوم، إلخ.';
$string['export_programs_help'] = 'البرامج، الأسماء، الأوصاف، التواريخ، الوسوم، إلخ.';
$string['futureallocation'] = 'التخصيص المستقبلي';
$string['idnumber'] = 'معرّف المستخدم';
$string['import_content_help'] = 'الشهادات، الأسماء، الأوصاف، التواريخ، الوسوم، إلخ.';
$string['import_programs_help'] = 'البرامج، الأسماء، الأوصاف، التواريخ، الوسوم، إلخ.';
...
$string['newvaluefor'] = 'القيمة الجديدة لـ';
$string['privacy:metadata:core_tag'] = 'الوسوم المضافة إلى الشهادات';
