...
/**
 * Strings for component 'block_xp', language 'ar', version '3.10'.
 *
 * @package     block_xp
 * @category    string
...
$string['errorcontextcoursemismatchpercourse'] = 'إن رابط صفحة <em>الترقي!</em> هذه لا تتوافق مع التهيئة الحالية للملحق. التهيئة الحالية عندك تعلن بأن <em>الترقي!</em> يُستعمل \'لكل مساق\'، ولكن هذه الصفحة تتوقع استعماله على مستوى \'كل الموقع\'. هذا غالباً منشؤه <em>كتلة</em> أضيفت إلى دفة القيادة أو صفحة الواجهة في أثناء تهيئة مختلفة. ينبغي عليك إزالة الكتلة من الصفحات اللاحقة، واستعمالها من داخل المساقات الفردية فقط.';
