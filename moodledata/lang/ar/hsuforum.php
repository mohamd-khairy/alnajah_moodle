...
/**
 * Strings for component 'hsuforum', language 'ar', version '3.10'.
 *
 * @package     hsuforum
 * @category    string
...
$string['addanewtopic'] = 'إضافة مناقشة جديدة';
$string['addyourdiscussion'] = 'أضف مناقشتك';
...
$string['anonymousrecentactivity'] = 'قد يكون هناك نشاط جديد في هذا المنتدى، ولكن يتعذر عرض التفاصيل لأن المنتدى غير مشخصن.';
$string['anonymouswarning'] = 'عبر نقل موضوع المناقشة هذا، قد تكشف معلومات غير مشخصنة. هل أنت متأكد من رغبتك في القيام بذلك؟';
$string['cannnotdeletesinglediscussion'] = 'عذرًا، ليس مسموحًا لك بحذف تلك المناقشة!';
...
$string['cannotfindorcreateforum'] = 'تعذر العثور على منتدى الإعلانات الرئيسي لهذا الموقع أو إنشائه';
$string['cannotmakeprivatereplies'] = 'عذرًا، ليس مسموحًا لك بتقديم ردود خاصة في هذا المنتدى';
...
$string['cansubscribediscerror'] = 'ليس مسموحًا لك بالاشتراك في هذه المناقشة.';
$string['completiondiscussions'] = 'ينبغي على الطالب إنشاء المناقشات:';
$string['completiondiscussionsdesc'] = 'ينبغي على الطالب إنشاء {$a} من المناقشات على الأقل';
...
$string['completionpostsdesc'] = 'ينبغي على الطالب تقديم {$a} من المناقشات أو الردود على الأقل';
$string['completionpostshelp'] = 'يتطلب إكتمال المناقشات أو الردود';
$string['completionreplies'] = 'ينبغي على الطالب تقديم الردود:';
$string['completionrepliesdesc'] = 'ينبغي على الطالب طرح {$a} من المناقشات على الأقل';
$string['configenabletimedposts'] = 'أضبطه على \'نعم\' إذا أردت السماح بتحديد فترات العرض عند نشر مناقشة جديدة في المنتدى.';
$string['confighiderecentposts'] = 'إجعله نعم لإيقاف عرض منشورات المنتدى الأخيرة في صفحة المساق';
$string['configlongpost'] = 'أي منشور يزيد عن هذا الحد (مقاساً بالحروف غير المتضمنة لرموز HTML) يعتبر طويلاً. المنشورات المعروضة في صفحة واجهة الموقع، صفحات المقررات الدراسية ذات النمط الاجتماعي، أو الملفات الشخصية للمستخدمين يتم تقصيرها إلى فاصل طبيعي في موضع ما بين قيمتي hsuforum_shortpost و hsuforum_longpost.';
$string['configmanydiscussions'] = 'الحد الأقصى لعدد للمناقشات المعروضة في الصفحة الواحد للمنتدى';
$string['configoldpostdays'] = 'عدد الأيام التي تعتبر بعدها المنشورات مقروءة.';
...
$string['discussion:x'] = 'المناقشة: {$a}';
$string['discussiondisplay'] = 'عرض المناقشة';
...
$string['discussionlockingheader'] = 'تأمين المناقشة';
...
$string['discussionsubscribers'] = 'مشتركو المناقشة';
$string['discussionsummary'] = 'جدول بكل مناقشات المنتدى في {$a}. حقلا First name و last name هما دمج ما بين حقول الاسم الأول والاسم الأخير والصورة للمستخدم.';
$string['displaydiscussionreplies'] = 'عرض ردود المناقشة';
...
$string['forumbodydeleted'] = 'محتوى منشور المنتدى هذا قد تمت إزالته ولا يمكن الوصول إليه بعد الآن.';
...
$string['general'] = 'عام';
$string['hsuforum:addinstance'] = 'إضافة منتدى جديد';
$string['hsuforum:addquestion'] = 'إضافة سؤال';
$string['hsuforum:canoverridediscussionlock'] = 'الرد على المناقشات المؤمنة';
$string['hsuforum:exportdiscussion'] = 'تصدير المناقشة بأكملها';
$string['hsuforum:managesubscriptions'] = 'إدارة الاشتراكات';
$string['hsuforum:movediscussions'] = 'نقل المناقشات';
$string['hsuforum:pindiscussions'] = 'تثبيت المناقشات';
$string['hsuforum:splitdiscussions'] = 'فصل المناقشات';
$string['hsuforum:startdiscussion'] = 'بدء مناقشات جديدة';
$string['hsuforum:viewdiscussion'] = 'معاينة المناقشات';
...
$string['javascriptdisableddisplayformat'] = 'تم تعطيل Javascript في مستعرضك. يرجى تمكين Javascript وإعادة تحميل الصفحة أو اختيار طريقة عرض أخرى للمناقشة.';
$string['loadmorediscussions'] = 'تحميل المزيد من المناقشات';
...
$string['managesubscriptionson'] = 'إدارة الاشتراكات';
...
$string['modulename_help'] = 'تُمكن وحدة نشاط المنتدى المفتوح المشاركين من إجراء مناقشات غير متزامنة، أي المناقشات التي تجري على مدى فترة طويلة من الزمن.
...
$string['myprofileotherdis'] = 'مناقشات المنتدى المفتوح';
$string['myprofileowndis'] = 'مناقشاتي في المنتدى المفتوح';
$string['nextdiscussion'] = 'المناقشة الأحدث';
...
$string['nopostforum'] = 'عذرًا، ليس مسموحًا لك بالنشر في هذا المنتدى';
...
$string['onediscussion'] = 'مناقشة واحدة';
...
$string['page-mod-hsuforum-view'] = 'الصفحة الرئيسية لوحدة المنتدى';
$string['page-mod-hsuforum-x'] = 'أي صفحة لوحدة المنتدى';
$string['participants'] = 'المشاركون';
$string['postaddedtimeleft'] = 'لديك {$a} لتحريره إذا أردت إجراء أي تعديلات عليه.';
$string['postbymailsuccess'] = 'تهانينا، منشورك في المنتدى الذي موضوعه "{$a->subject}" تمت إضافته بنجاح. يمكنك مشاهدته في {$a->discussionurl}.';
$string['previousdiscussion'] = 'المناقشة الأقدم';
...
$string['privacy:metadata:hsuforum_discussion_subs'] = 'معلومات عن الاشتراكات في مناقشات المنتدى الفردية';
$string['privacy:metadata:hsuforum_discussions'] = 'معلومات عن مناقشات المنتدى الفردية التي أنشأها المستخدم';
$string['privacy:metadata:hsuforum_discussions:name'] = 'اسم المناقشة، كما اختاره المؤلف';
$string['privacy:metadata:hsuforum_posts:parent'] = 'المنشور ذو الرتبة الأعلى الذي تم الرد عليه';
$string['privacy:metadata:hsuforum_queue:discussionid'] = 'مُعرَّف المناقشة';
$string['privacy:metadata:hsuforum_read:postid'] = 'المنشور الذي تمت قراءته';
$string['privacy:metadata:hsuforum_subscriptions_disc'] = 'معلومات عن الاشتراكات في مناقشات المنتدى المفتوح الفردية';
$string['privacy:metadata:hsuforum_subscriptions_disc:discussion'] = 'مُعرَّف المناقشة التي تم الاشتراك فيها';
...
$string['privacy:request:delete:post:message'] = 'محتوى هذا المنشور قد تم حذف بناءً على طلب من كاتبه.';
...
$string['showdiscussionsubscribers'] = 'إظهار/إخفاء مشتركي المناقشة';
$string['showrecent'] = 'عرض منشورات المنتدى الأخيرة في صفحة المساق';
$string['showrecent_help'] = 'عند تمكينه، فسيعرض منشورات المنتدى الأخيرة في صفحة المساق.';
$string['singleforum'] = 'نقاش واحد بسيط';
$string['sortdiscussions'] = 'فرز المناقشات';
$string['subscribedisc'] = 'إشترك في هذه المناقشة';
...
$string['tagsdeleted'] = 'تم حذف وسوم المنتدى';
$string['unsubscribedisc'] = 'إلغاء اشتراكك في هذه المناقشة';
