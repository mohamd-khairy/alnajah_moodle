...
/**
 * Strings for component 'theme_schoollege', language 'ar', version '3.10'.
 *
...
$string['defaultbackgroundimage_desc'] = 'هذه الصورة تستعمل في منطقة العنوان لكل صفحات مودل الرئيسية: دفة القيادة، الملف الشخصي، الصفحة الرئيسية، كل الصفحات المجاورة لصفحات المساقات.';
...
$string['rawscsspre_desc'] = '// منطقة التنقل العلوي</br>
$navbar-bg: #e3eaf5 ;</br>
$navbartextcolor: #333;</br>

// منطقة العنوان العلوي</br>
$header-bg: #eef5f9;</br>

// Breadcrumbs في schoollege</br>
...
//قائمة أيقونات الشريط الجانبي</br>
