...
/**
 * Strings for component 'format_flexpage', language 'ar', version '3.10'.
 *
...
$string['frontpage'] = 'استعمال Flexpage في صفحة الواجهة';
$string['frontpagedesc'] = 'هذا من شأنه تمكين تنسيق Flexpage في صفحة الواجهة.';
$string['name'] = 'الاسم';
