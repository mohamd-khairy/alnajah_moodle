...
/**
 * Strings for component 'tool_cmdlinetools', language 'ar', version '3.10'.
 *
...
$string['add_assignment_capa_cli_help'] = 'إضافة إمكانية الأخذ بزمام التحكم بحالة الإظهار للإفادة أو ملاحق الواجب في السياقات
طريقة الاستعمال:
...
$string['apply_defaults_settings_to_plugin_cli_settingset'] = 'مجموعة الملحق {$a->plugin} المفتاح {$a->key} القيمة {$a->value}';
...
الخيارات:
-h, --help                 طباعة هذه التعليمات';
$string['delete_plugin_cli_help'] = 'حذف الملحق
...
plugintype هو
		...
		tool
pluginname هو اسم الملحق (اسم مجلد الملحق)

الخيارات:
-h, --help                 طباعة هذه التعليمات';
$string['hideshow_plugin_cli_help'] = 'إخفاء/إظهار الملحق
...
هو اسم الملحق (اسم مجلد الملحق)
hideshow هو قيمة رقمية صحيحة، 0 يمثل خطأ أو إطفاء (ملحق المرشح)، 1 يمثل صواب أة تشغيل (ملحق المرشح)، -9999 تمثل التعطيل (ملحق المرشح)

الخيارات:
-h, --help                 طباعة هذه التعليمات';
$string['namevaluerequired_set_config_cli'] = 'ينبغي عليك إدخال إما المعامل  --name أو المعامل --value';
$string['remove_assignment_capa_cli_help'] = 'إزالة إمكانية الأخذ بزمام التحكم بحالة الإظهار للإفادة أو ملاحق الواجب في السياقات
طريقة الاستعمال:
...
-n, --name=config_name     تهيئة الاسم إذا كان الوضع هو لا استدعاء مثل config_param_name، إذا كان معامل تهيئة عام، أو  plugintype_pluginname/config_param_name إذا كان اسم معامل الملحق
