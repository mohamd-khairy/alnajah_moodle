...
/**
 * Strings for component 'qtype_pmatch', language 'ar', version '3.10'.
 *
...
$string['privacy:metadata:preference:pagesize'] = 'عدد محاولات أسئلة مطابقة النمط المعروضة لكل صفحة.';
...
$string['testquestionformnewresponsebutton'] = 'إضافة استجابة جديدة';
$string['testquestionformsaveresponsebutton'] = 'حفظ';
$string['testquestionformtestsubmit'] = 'فحص الاستجابات المحددة';
$string['testquestionheader'] = 'فحص السؤال: {$a}';
$string['testquestionidlabel'] = '#';
$string['testquestionresponse'] = 'الاستجابة';
$string['testquestionresponsesthatare'] = 'الاستجابات التي';
...
$string['testquestionuploadanother'] = 'إرفع ملفاً آخر';
$string['testquestionuploadresponses'] = 'إرفع الاستجابات';
$string['testquestionuploadtheseresponses'] = 'إرفع هذه الاستجابات';
$string['testsubquestionx'] = 'إفحص السؤال الفرعي {$a}';
$string['testthisquestion'] = 'إفحص هذا السؤال';
$string['testthisquestionnoresponsesfound'] = 'لم يُعثر على أي استجابة.';
