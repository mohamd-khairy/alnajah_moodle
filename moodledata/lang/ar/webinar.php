...
/**
 * Strings for component 'webinar', language 'ar', version '3.10'.
 *
 * @package     webinar
 * @category    string
...
$string['sessiondeletedmessage'] = 'عزيزي {$a->name}،

لقد تم إلغاء جلسة التدريب التي سجلت لحضورها. تفاصيل الجلسة كانت كما يلي:
...
$string['sessionregistermessage'] = 'عزيزي {$a->name}،

لقد تم تسجيلك لحضور جلسة التدريب التي تبدأ في {$a->starttime}.
...
لحضور الجلسة، أنقر الرابط أدناه في الوقت المقرر. هذا سيأخذك إلى قائمة جلسات الندوة حيث ستجد زر \'الانضمام\' بجوار الندوة التي سجلت فيها. أنقر الزر للانضمام إلى الجلسة التدريبية.

{$a->sessionurl}

يرجى ملاحظة: زر \'الانضمام\' لن يكون متاحًا حتى تشرع الجلسة بالانعقاد.';
$string['sessionsdetailstablesummary'] = 'وصف كامل للجلسة الحالية.';
$string['sessionsoncoursepage'] = 'الجلسات المعروضة في صفحة المساق';
$string['sessionunregistermessage'] = 'عزيزي {$a->name}،

لقد تم إلغاء تسجيلك في جلسة التدريب الآتية والتي كانت مجدولة لتبدأ في {$a->starttime}.
...
{$a->webinaragenda}';
$string['sessionupdatedmessage'] = 'عزيزي {$a->name}،

لقد تم تغيير جلسة التدريب التي سجلت فيها. التفاصيل الجديدة هي كما يأتي:
...
يرجى ملاحظة: زر \'الانضمام\' لن يكون متاحًا حتى تشرع الجلسة بالانعقاد.';
$string['setting:messagesenderusername'] = 'اسم المستخدم في مودل للشخص الذي رسائله المصدرة من قبل وحدة الندوة عبر الإنترنت سيتم إرسالها باسمه (إذا تم استعمال نظام المراسلة في مودل).';
