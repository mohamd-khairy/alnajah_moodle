...
/**
 * Strings for component 'tool_trigger', language 'ar', version '3.10'.
 *
...
$string['step_lookup_course:privacy:coursedata_desc'] = 'بيانات عن المساقات، تتضمن المُعرَّف، اسم المساق، تاريخي البدء والانتهاء، إلخ.';
