...
/**
 * Strings for component 'qtype_coderunner', language 'ar', version '3.10'.
 *
...
$string['allowattachments_help'] = 'فيما إذا كان ينبغي السماح للطلاب بإضافة مرفقات إلى تسليماتهم، وإن كان الجواب بنعم، كم من تلك المرفقات يتم نسخها إلى مجلد تشغيل العمل، مع قائمة مفصولة بفوارز لأسماء المرفقات يتم تقديمها إلى القالب في المتغير Twig {{ ATTACHMENTS }}. تحذير: السماح بالمرفقات قد تكون له تبعات على الأداء أو مساحة الخزن وبخاصة في مواقع مودل ذات العدد الكبير من المقررات الدراسية أو التي تسمح برفع ملفات كبيرة الحجم. مخدمات مودل ومخدمات Jobe قبل شباط 2019، تخزن كل المرفقات إلى أجل غير مسمى.';
...
$string['bad_empty_splitter'] = 'لا يمكن لمقسم الاختبار أن يكون فارغاً عند استعمال قالب الدمج';
...
$string['feedback_help'] = 'إختر \'يتم ضبطها من قبل الاختبار\' للسماح بإعدادات الإفادة الخاصة بالاختبار بالتحكم بعرض جدول النتائج، \'فرض العرض\' لإظهار جدول النتائج بغض النظر، و\'فرض الإخفاء\' لإخفائه في جميع الأحوال';
...
لحالة الفحص بمثابة تعبير إعتيادي ثم يفحص المخرجات
للتحري عن وجود مطابقة مع النتيجة المتوقعة في أي مكان.
لفرض المطابقة مع المخرجات بالكامل، إبدأ التعبير الإعتيادي
وأنهه بـ \'\\A\' و \'\\Z\' على التوالي. تستعمل مطابقة التعبير
الإعتيادي خيارات MULTILINE و DOTALL.

يفرض خيار \'مُقيِّم القالب\' بأن مخرجات البرنامج هي
في الواقع نتيجة التقييم بحد ذاتها، بعبارة أخرى، إن القالب
لا يفحص *ولا يُقيِّم* إجابة الطالب.
المخرجات الوحيدة من هكذا قالب للبرنامج ينبغي أن تكون
سجل بترميز JSON.

إذا كان القالب هو قالب لكل فحص (أي ليس مُدمِجاً)، فعلى جملة JSON أن تصف صفاً
...
من قبل برنامج منح العلامات باستعمال القالب وسيتم استعمالها بدلاً من القيم من حالة الفحص.
كمثال على ذلك، إذا كانت مخرجات البرنامج هي ما يأتي:
<code>{"fraction":0.5, "got": "Half the answers were right!"}</code>،
سيتم منح نصف الدرجات لحالة الفحص تلك، وعمود \'Got\' سيعرض النص "Half the
answers were right!". يمكن إضافة أعمدة أخرى إلى جدول النتائج عبر إضافة سمات
إضافية إلى سجل JSON فضلاً عن حقل أعمدة النتائج للسؤال نفسه.

إذا كان القالب مُدمِجاً، ينبغي لمخرجات جملة JSON القادمة من مُقيِّم القالب أن تحتوي مرة
أخرى على حقل \'fraction\'، ولكن هذه المرة بالنسبة إلى الدرجة الإجمالية، وقد تحتوي صفراً
أو المزيد من \'prologuehtml\'، \'testresults\'، \'epiloguehtml\'، \'columnformats\'،
\'showoutputonly\' and \'showdifferences\'.
إن حقلي \'prologuehtml\' و \'epiloguehtml\' هما بتنسيق html ويتم عرضهما على التوالي
قبل جدول النتائج (الإختياري) وبعده. إن حقل \'testresults\'، إذا تم ذكره، هو قائمة للقوائم
...
$string['hoisttemplateparams'] = 'عوامل قالب Hoist';
