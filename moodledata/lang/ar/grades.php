...
/**
 * Strings for component 'grades', language 'ar', version '3.10'.
 *
 * @package     grades
 * @category    string
...
$string['aggregationcoefextraweight_help'] = 'إن كان وزن الرصيد الإضافي موضوعاً على قيمة أعلى من الصفر، فإن الدرجة ستكون بمثابة رصيد إضافي عند التجميع. الرقم سيكون هو المعامل الذي ستُضرب به الدرجة قبل إضافتها إلى الإجمالي من أجل إحتساب المتوسط.';
...
$string['excluded_help'] = 'عند تأشيره، فالدرجة لن يتم تضمينها في أي تجميع.';
