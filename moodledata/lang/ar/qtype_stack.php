...
/**
 * Strings for component 'qtype_stack', language 'ar', version '3.10'.
 *
 * @package     qtype_stack
 * @category    string
...
$string['ATFacForm_error_degreeSA'] = 'تعذر على نظام المصادقة المركزي تأسيس الدرجة الجبرية لإجابتك.';
...
$string['ATRegEx_missing_option'] = 'هناك تعبير إعتيادي مفقود في حقل خيار نظام المصادقة المركزي.';
...
$string['deploymany'] = 'محاولة النشر التلقائي العدد الآتي من المتغيرات:';
...
$string['healthcheckconfig'] = 'ملف تهيئة Maxima';
$string['healthcheckconfigintro1'] = 'تم العثور عليه، وهو يستعمل Maxima في المجلد الآتي:';
$string['healthcheckconfigintro2'] = 'محاولة كتابة ملف تهيئة Maxima تلقائياً.';
...
$string['questionnotempty'] = 'لا يمكن لملاحظة السؤال أن تكون فارغة عندما تظهر الدالة rand() بين متغيرات السؤال.';
...
$string['specificfeedbacktags'] = 'ينبغي أن لا تتضمن الإفادة الخاصة الترميز/الترميزات \'{$a}\'.';
