...
/**
 * Strings for component 'qtype_mtf', language 'ar', version '3.10'.
 *
 * @package     qtype_mtf
 * @category    string
...
$string['feedbackforoption'] = 'الإفادة لـ';
...
استعمل الإفادة العامة، على سبيل المثال لشرح الإجابات الصحيحة أو إعطاء الطلاب رابطًا لمعلومات إضافية.';
...
$string['optionsandfeedback'] = 'الخيارات والإفادات';
...
$string['privacy:metadata'] = 'إن ملحق نوع السؤال، MTF لا يخزن أي بيانات شخصية.';
...
$string['scoringmethod_help'] = 'هناك طريقتان بديلتان لتسجيل الأهداف. <br /><strong>النقاط الفرعية</strong> (مستحسن): يتم منح الطالب نقاط فرعية لكل استجابة صحيحة.<br/><strong>MTF1/0</strong>: يتلقى الطالب نقاط كاملة إذا كانت كل الردود صحيحة، وصفرًا بخلاف ذلك.';
$string['scoringmtfonezero'] = 'MTF1 / 0';
$string['scoringsubpoints'] = 'نقاط فرعية';
$string['shuffleanswers'] = 'خيارات خلط الاستجابات';
