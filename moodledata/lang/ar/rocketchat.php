...
/**
 * Strings for component 'rocketchat', language 'ar', version '3.10'.
 *
 * @package     rocketchat
 * @category    string
...
$string['background_enrolment_task_desc'] = 'هذه لحل مشكلة الأداء عند ضم أعداد كبيرة من المستخدمين.</br> سيمنع هذا من يقوم بضم المستخدمين من الانتظار في صفحة الانضمام للمقرر الدراسي في أثناء ضم / إلغاء ضم عدد كبير من المستخدمين.</ br> اختيار أسلوب ضم الأفواج والملف النصي CSV، إذا تم تمكينه، ينصح به بشدة';
...
$string['background_synchronize_desc'] = 'يحدث هذا بعد استعادة المقرر الدراسي أو وحدة Rocket.Chat من سلة المحذوفات،';
...
$string['defaultmoderatorroles_desc'] = 'أدوار مودل في المقرر الدراسي التي ستؤدي دور المشرفين في Rocket.Chat';
$string['defaultuserroles'] = 'مستخدمو Rocket.Chat.';
$string['defaultuserroles_desc'] = 'أدوار مودل في المقرر الدراسي التي ستؤدي دور المشرفين في Rocket.Chat (مع حقوق المستخدم العادية)';
...
$string['instanceurl'] = 'عنوان URL لمثيل Rocket.Chat';
...
$string['modulename_help'] = 'ستؤدي إضافة هذا النشاط إلى المقرر الدراسي في مودل إلى إنشاء قناة خاصة في Rocket.Chat ودفع مستخدمي مودل المرتبطين بهذا النشاط كأعضاء في هذه القناة التي تم إنشاؤها حديثًا.
...
$string['name'] = 'اسم المثيل (في المقرر الدراسي)';
...
$string['recyclebin_patch'] = 'هل تم تثبيت التصحيح الأساسي لصندوق إعادة التدوير؟';
...
$string['usernamehook_desc'] = 'من خلال تنشيط هذا الخيار ، سيكون من الممكن تغيير اسم مستخدم مودل ليلائم اسم مستخدم Rocket.Chat. </br> قم بإنشاء ملف hooklib.php في دليل تثبيت وحدة Rocket.Chat. </br> كود moodle_username_to_rocketchat الذي سيعيد مودل المحول اسم المستخدم ليناسب Rocket.Chat one. </br> hooklib-example.php مُعطى كمثال.';
