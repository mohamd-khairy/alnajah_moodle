...
/**
 * Strings for component 'tool_reportbuilder', language 'ar', version '3.10'.
 *
...
$string['certificatesissues'] = 'منح الشهادات';
$string['certificatetemplates'] = 'قوالب الشهادات';
$string['checkboxanyvalue'] = 'أي قيمة';
$string['checkboxischecked'] = 'نعم';
$string['checkboxisnotchecked'] = 'كلا';
$string['choose'] = 'اختر';
$string['conditionshelp'] = 'الشروط';
$string['conditionshelp_help'] = 'قائمة بالشروط المحددة مسبقاً والتي تنطبق دائماً عند عرض هذا التقرير.';
...
$string['course_completion_days_course'] = 'أيام أخذ المقرر الدراسي';
$string['course_completion_days_enrolled'] = 'أيام الانضمام';
...
$string['coursefullnamewithlink'] = 'الاسم الكامل للمساق مع رابطه';
$string['dateanyvalue'] = 'أي قيمة';
$string['datelast'] = 'الأيام كذا الماضية';
$string['datenext'] = 'الأيام كذا القادمة';
$string['description'] = 'الوصف';
$string['editreport'] = 'تحرير المحتوى';
$string['entitycertificate'] = 'الشهادة';
$string['entitycertificateissue'] = 'منح الشهادة';
$string['errormanageschedules'] = 'ليست لديك صلاحية إدارة المواعيد المجدولة';
$string['eventreportcreated'] = 'تقرير تم إنشاؤه';
$string['eventreportdeleted'] = 'تقرير تم حذفه';
$string['eventreportschedulecreated'] = 'جدولة تقرير تم إنشاؤها';
$string['eventreportscheduledeleted'] = 'جدولة تقرير تم حذفها';
$string['eventreportscheduleupdated'] = 'جدولة تقرير تم تحديثها';
$string['eventreportupdated'] = 'تقرير تم تحديثه';
$string['eventreportviewed'] = 'تقرير تمت معاينته';
$string['fullnamewithlink'] = 'الاسم الكامل مع رابط الملف الشخصي';
$string['fullnamewithpicture'] = 'الاسم الكامل مع الصورة';
$string['fullnamewithpicturelink'] = 'الاسم الكامل مع الصورة والرابط';
$string['lessthanaday'] = 'أقل من يوم';
$string['newvaluefor'] = 'القيمة الجديدة لـ \'{$a}\'';
$string['numberanyvalue'] = 'أي قيمة';
$string['privacy:metadata:reportbuilder:name'] = 'اسم التقرير';
$string['privacy:metadata:reportbuilder_schedule:name'] = 'اسم جدول المواعيد';
$string['privacy:metadata:reportbuilder_schedule:scheduled'] = 'الوقت الذي يستوجب عنده بدء المهمة';
$string['recurrencedailyweekday'] = 'يومياً - أيام الأسبوع';
