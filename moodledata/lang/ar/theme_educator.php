...
/**
 * Strings for component 'theme_educator', language 'ar', version '3.10'.
 *
...
$string['blocktitlebggbottom'] = 'لون الخلفية أسفل عنوان الكتلة';
$string['blocktitlebggbottomdesc'] = 'إختيار لون الخلفية السفلي للعنوان.';
$string['blocktitlebggtop'] = 'لون الخلفية أعلى عنوان الكتلة';
$string['blocktitlebggtopdesc'] = 'إختيار لون الخلفية العلوي للعنوان.';
$string['choosereadme'] = '<div class="clearfix">
    ...
    <div class="theme_description">
        <h2>عن</h2>
        <p>المربي هو مظهر ذو عرض سلس وثلاثة أعمدة منقول إلى الإصدار 2.0 من مودل 1.X.</p>
        <h2>التغييرات</h2>
    ...
    <h2>أصحاب الفضل</h2>
    <p>تم تطوير هذا المظهر وإدامته من قبل <a href="http://www.thedigitalgroup.com/">The Digital Group</a></p>
        <h2>الرخصة</h2>
...
$string['creditstomoodleorgdesc'] = 'عرض شعار مودل التقليدي الصغير عند أسفل الصفحة';
$string['ctmo_onfrontpageonly'] = 'في صفحة الواجهة فقط';
$string['custombannerimg'] = 'صورة اللافتة المخصصة';
$string['custombannerimgdesc'] = 'قم بتغيير صورة اللافتة لهذا المظهر عبر إدخال عنوان الرابط الكامل أو النسبي للصورة التي ترغب باستعمالها (مثلاً http://www.yoursite.com/banner.png أو ../path/to/your/banner.png).';
...
$string['custommenubgc'] = 'لون خلفية القائمة الكخصصة';
$string['custommenubgcdesc'] = 'هذا سيحدد لون خلفية القائمة المخصصة للمظهر.';
$string['displayblocktitlecolour'] = 'لون خلفية عنوان الكتلة';
$string['displayblocktitleimage'] = 'لون خلفية عنوان الكتلة';
$string['displayheading'] = 'عَرض عنوان الصفحة';
$string['displaylogo'] = 'عَرض الشعار';
...
$string['headerbgcdesc'] = 'هذا يضبط لون خلفية الرأس للكتل في المظهر.';
$string['headerbgctop'] = 'لون الخلفية العلوي لعنوان الصفحة';
$string['headerbgctopdesc'] = 'إختيار لون الخلفية العلوي لعنوان الصفحة.';
$string['headerbggbottom'] = 'لون الخلفية السفلي لعنوان الصفحة';
$string['headerbggbottomdesc'] = 'إختيار لون الخلفية السفلي لعنوان الصفحة.';
$string['headercontentdesc'] = 'التخيُّرما بين عرض شعار مودل أو نص عنوان الصفحة في رأسها.';
$string['inputbbgc'] = 'إختر لون الخلفية لزر الإدخال.';
$string['inputbbgcdesc'] = 'هذا يحدد لون الخلفية لزر الإدخال.';
$string['inputtextc'] = 'إختر لون نص الإدخال.';
$string['inputtextcdesc'] = 'هذا يحدد لون نص الإدخال.';
$string['lblockcolumnbgc'] = 'لون خلفية العمود الأيمن';
$string['lblockcolumnbgcdesc'] = 'هذا سيحدد لون خلفية عناوين الكتل للمظهر.';
$string['menu_title_bg'] = 'متقي عنوان القائمة';
$string['menu_title_bgdesc'] = 'تحديد ما إذا كان ينبغي عرض منتقي عنوان قائمة مودل';
