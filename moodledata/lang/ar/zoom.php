...
/**
 * Strings for component 'zoom', language 'ar', version '3.10'.
 *
 * @package     zoom
 * @category    string
...
$string['cachedef_sessions'] = 'الحصول على معلومات من Zoom طلب تقرير المستخدم';
...
$string['zoomerr_apikey_missing'] = 'مفتاح تطبيق Zoom غير موجود';
$string['zoomerr_apisecret_missing'] = 'لم يتم العثور على Zoom API secret';
$string['zoomerr_id_missing'] = 'يجب عليك تحديد معرف المقرر_الوحدة أو معرف النسخة';
