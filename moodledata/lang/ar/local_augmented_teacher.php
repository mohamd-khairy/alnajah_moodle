...
/**
 * Strings for component 'local_augmented_teacher', language 'ar', version '3.10'.
 *
...
$string['edit'] = 'تعديل';
$string['enabled'] = 'مفعل';
$string['eventremindercreated'] = 'تذكير تم إنشاؤه';
$string['eventreminderdeleted'] = 'تذكير تم حذفه';
$string['eventreminderupdated'] = 'تذكير تم تحديثه';
...
$string['sendremindermessage'] = 'إرسال رسالة تذكير';
$string['shortcodes'] = 'رموز قصيرة';
$string['smallmessage'] = 'الرسالة';
