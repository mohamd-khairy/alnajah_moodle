...
/**
 * Strings for component 'local_qeupgradehelper', language 'ar', version '3.10'.
 *
...
$string['areyousuremessage'] = 'هل ترغب بالاستمرار وترقية كل المحاولات {$a->numtoconvert} في الاختبار \'{$a->name}\' في المقرر الدراسي {$a->shortname}?';
$string['areyousureresetmessage'] = 'الاختبار \'{$a->name}\' في المقرر الدراسي {$a->shortname} فيه {$a->totalattempts} محاولة، منها {$a->convertedattempts} تمت ترقيتها من النظام القديم. من تلك المحاولات، {$a->resettableattempts} يمكن إعادة تعيينها من أجل معاودة تحويلها. هل ترغب بالاستمرار في ذلك؟';
...
$string['upgradingquizattempts'] = 'ترقية المحاولات للاختبار \'{$a->name}\' في المقرر الدراسي {$a->shortname}';
