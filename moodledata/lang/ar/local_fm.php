...
/**
 * Strings for component 'local_fm', language 'ar', version '3.10'.
 *
 * @package     local_fm
 * @category    string
...
$string['nomessagepermissions'] = 'ليست لديك صلاحية تحرير قالب إفادة البريد الالكتروني.';
...
$string['reportvariables'] = 'تضمين المتغير الآتي في موضع ما من قالب تقريرك لتعيين الموضع الذي ينبغي فيه وضع كتلة الإفادة.
