...
/**
 * Strings for component 'filter_filtercodes', language 'ar', version '3.10'.
 *
...
$string['formcourserequest'] = '<form action="{wwwroot}/local/contact/index.php" method="post" class="cf new-course-request">
    <fieldset>
        ...
        <div class="form-group">
            <label for="new_course_name" id="new_course_namelabel" class="d-block">الاسم المقترح للمقرر الدراسي الجديد <strong class="required">(مطلوب)</strong></label>
            <input id="new_course_name" name="new_course_name" type="text" size="57" maxlength="80" minlength="5"
                    title="الحد الأدنى 5 حروف." required="required">
        </div>
        <div class="form-group">
            <label for="description" id="descriptionlabel" class="d-block">وصف المقرر الدراسي <strong class="required">(مطلوب)</strong></label>
    ...
    <div>
        <input type="submit" name="submit" id="submit" value="إرسال الطلب لهذا المقرر الدراسي">
    </div>
</form>';
...
$string['privacy:metadata'] = 'إن ملحق رموز المرشح لا يخزن أي بيانات شخصية عن أي مستخدم.';
$string['sizeb'] = '&nbsp;بايت';
