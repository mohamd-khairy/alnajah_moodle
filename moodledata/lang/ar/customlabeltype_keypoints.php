...
/**
 * Strings for component 'customlabeltype_keypoints', language 'ar', version '3.10'.
 *
...
$string['keypoints:view'] = 'يمكنه معاينة المحتوى';
$string['template'] = '<table class="custombox-keypoints" cellspacing="0" width="100%">
<tr valign="top">
