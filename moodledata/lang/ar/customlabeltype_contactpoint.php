...
/**
 * Strings for component 'customlabeltype_contactpoint', language 'ar', version '3.10'.
 *
...
$string['contactpoint:view'] = 'يمكنه معاينة المحتوى';
$string['facetoface'] = 'لقاء جسدي';
...
<tr valign="top">
    ...
    <td class="custombox-header-caption contactpoint" width="98%" colspan="2">
        نقطة الاتصال...<br/>
        <span class="custombox-header-caption contacttype">الطريقة : <%%contacttype%%></span>
    </td>
</tr>
<tr>
