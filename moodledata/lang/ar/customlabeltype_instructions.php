...
/**
 * Strings for component 'customlabeltype_instructions', language 'ar', version '3.10'.
 *
...
$string['instructions:view'] = 'يمكنه معاينة المحتوى';
$string['template'] = '<table class="custombox-instructions" cellspacing="0" width="100%">
<tr valign="top">
