...
/**
 * Strings for component 'theme_adaptable', language 'ar', version '3.10'.
 *
...
$string['activatetemplateoverride'] = 'تفعيل تجاوز القالب لـ \'{$a}\'';
...
$string['blocklayoutbuilder'] = 'مناطق كتل الواجهة الأمامية';
...
$string['categoryheadercustomcssdesc'] = 'تعيين أنماط CSS للتصنيف الأعلى رتبة \'{$a->name}\' ذي المُعرَّف \'{$a->id}\'. هذا من شأنه توليد نصوص CSS لمنتقي المظاهر مسبوقة بـ \'.category-{$a->id}\'. إذا لم يبدُ على أنماط CSS بأنها مطبقة، تحقق من ملف وقوعات PHP.';
$string['categoryheadercustomcssdescchildren'] = 'تعيين أنماط CSS للتصنيف الأعلى رتبة \'{$a->name}\' ذي المُعرَّف \'{$a->id}\' وتفرعاته \'{$a->children}\'. هذا من شأنه توليد نصوص CSS لمنتقي المظاهر مسبوقة بـ \'.category-{$a->id}\' ولكل المُعرَّفات المتشعبة منه. إذا لم يبدُ على أنماط CSS بأنها مطبقة، تحقق من ملف وقوعات PHP.';
...
$string['coursesectionactivityleftborderwidth'] = 'عُرض الإطار الأيسر لنشاط مقطع المقرر الدراسي';
$string['coursesectionactivityleftborderwidthdesc'] = 'يضبط عُرض الإطار الذي يظهر على يسار نشاط مقطع المقرر الدراسي.';
...
$string['coursesettingsdesc'] = 'تخصيص بعض تنسيقات المساقات الأكثر استعمالاً في مودل لتتناسب مع التصميم الرئيسي.';
$string['coursetitlefullname'] = 'الاسم الكامل للمساق';
...
$string['customfontname'] = 'الخط الرئيسي المخصص';
$string['customfontnamedesc'] = 'أدخل اسم الخط الرئيسي المخصص فقط إذا سبق لك اختيار \'مخصص\' في القائمة المنسدلة للخط الرئيسي';
$string['customfonttitlename'] = 'نوع خط العنوان المخصص';
$string['customfonttitlenamedesc'] = 'أدخل اسم الخط المخصص للعنوان إذا سبق لك اختيار \'مخصص\' في القائمة المنسدلة لخط العنوان.';
$string['dangericoncolor'] = 'لون أيقونة التحذير';
...
$string['disablemenuscoursepages'] = 'تعطيل القوائم في صفحات المساقات';
$string['disablemenuscoursepagesdesc'] = 'تشغيل هذا الخيار سيحدد عرض القوائم العلوية بصفحات الموقع، الصفحة الرئيسية، ودفة القيادة (\'صفحتي الرئيسية\') إلخ. ولن تظهر في أي من صفحات المساق.';
...
$string['enableavailablecoursesdesc'] = 'عَرض عبارة "المساقات المتاحة" في الواجهة الأمامية.';
...
$string['enablehomedesc'] = 'عرض رابط للواجهة الأمامية';
...
$string['fonttitleweightdesc'] = 'إختر وزن الخط المستعمل في عناوين الموقع وعناوين المساقات. إختر قيمة تتراوح بين 100 إلى 900 اعتمادًا على الخط المحدد.';
...
$string['frontpagecoursesettings'] = 'قائمة مساقات الواجهة الأمامية';
...
$string['frontpagenumbertilesdesc'] = 'عدد بلاطات المساقات المراد عرضها لكل صف في قائمة مساقات صفحة الواجهة.';
...
$string['frontpagetickersettings'] = 'مؤشر الواجهة الأمامية';
...
$string['headertextcolor2'] = 'نص الكتل السفلى في العنوان ولون الروابط';
$string['headertextcolor2desc'] = 'تعيين نص الكتل السفلى في العنوان ولون الروابط.';
...
$string['homebk'] = 'صورة خلفية الواجهة الأمامية';
...
$string['infobox2desc'] = 'مربع المعلومات الثانوي في الواجهة الأمامية (أنظر ملف <a href="./../theme/adaptable/README.txt" target="_blank">README</a> لمزيد من المعلومات والتلميحات).<br><br><strong>ملاحظة: </strong><i>هذا العنصر مستعمل حصراً للتوافق مع BCU وستتم إزالته في الإصدارات القادمة.</i>';
$string['infoboxdesc'] = 'نصوص HTML لمربع المعلومات في الصفحة الأمامية (أنظر ملف <a href="./../theme/adaptable/README.txt" target="_blank">README</a> لمزيد من المعلومات والتلميحات).<br><br><strong>ملاحظة: </strong><i>هذا العنصر مستعمل حصراً للتوافق مع BCU وستتم إزالته في الإصدارات القادمة.</i>';
...
$string['menubordercolor'] = 'لون إطار القائمة الرئيسية السفلي';
...
$string['mysites'] = 'مقرراتي الدراسية';
...
$string['mysitesmenudisplayshortcodefullnameonhover'] = 'إظهار رمز الاختصار والاسم الكامل للمساق عند تحريك الماوس.';
...
$string['putpropertiesignorecti'] = 'تجاهل كل إعدادات صورة عناوين المساقات.';
...
$string['responsiveslider'] = 'منزلق الواجهة الأمامية';
$string['responsivesliderdesc'] = 'ما هي الشاشات المحجمة التي ترغب بعرض منزلق الواجهة الأمامية فيها؟';
...
$string['sitetitlecoursesdisabled'] = 'مُعطَّل - فقط أظهر عناوين المساقات في صفحاتها';
$string['sitetitlecoursesenabled'] = 'مُمَكَّن - أظهر عنوان الموقع وعناوين المساقات في صفحات المساقات';
...
$string['tabbedlayoutcoursepagelinkdesc'] = 'ليكن لديك تبويب يربطك رجوعاً إلى صفحة المقرر الدراسي ضمن تبويباته.';
