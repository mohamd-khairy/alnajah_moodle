...
/**
 * Strings for component 'theme_arialist', language 'ar', version '3.10'.
 *
...
$string['choosereadme'] = '<div class="clearfix">
	...
	<div class="theme_description">
		...
		<h2>عن</h2>
		<p>Arialist هو مظهر نظيف جدًا ذو عرض سلس وعمودين مخصص لمودل بالإصدار 2.0.</p>
	...
	<h2>أصحاب الفضل</h2>
	<p>تم إنشاء هذا المظهر وإدامته من قبل Patrick Malley من NewSchool Learning. يمكن التواصل معه عبرالبريد الالكتروني contact@newschoollearning.com. </p>
...
$string['regionwidth'] = 'عرض العمود';
$string['regionwidthdesc'] = 'هذا سيضبط عرض منطقتي الكتل التي تشكل العمودين الأيمن والأيسر.';
