...
/**
 * Strings for component 'customlabeltype_fundamental', language 'ar', version '3.10'.
 *
...
$string['fundamental:view'] = 'يمكنه معاينة المحتوى';
$string['template'] = '<table class="custombox-fundamental" cellspacing="0" width="100%">
<tr valign="top">
