...
/**
 * Strings for component 'ltiservice_basicoutcomes', language 'ar', version '3.10'.
 *
...
$string['allow'] = 'استعمل هذه الخدمة لقبول العلامات من الأداة';
$string['ltiservice_basicoutcomes'] = 'المخرجات الأساسية';
$string['ltiservice_basicoutcomes_help'] = 'اسمح للأداة بحفظ علاماتها واسترجاعها إلى عمود في سجل التقديرات متعلقٍ بكل رابط.';
