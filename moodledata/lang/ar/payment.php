...
/**
 * Strings for component 'payment', language 'ar', version '3.10'.
 *
 * @package     payment
 * @category    string
...
$string['paymentaccountsexplained'] = 'إنشاء حساب دفع مالي واحد أو أكثر لهذا الموقع. كل حساب يتضمن التهيئة الخاصة ببوابات الدفع المتاحة. الشخص الذي يقوم بتهية المدفوعات في الموقع (على سبيل المثال، مدفوعات الانضمام إلى المساقات) سيتمكن من الاختيار من بين الحسابات المتاحة.';
