...
/**
 * Strings for component 'block_course_contents', language 'ar', version '3.10'.
 *
...
$string['course_contents:addinstance'] = 'إضافة كتلة جديدة لمحتوى المقرر الدراسي';
$string['pluginname'] = 'محتويات المقرر الدراسي';
$string['privacy:metadata'] = 'محتويات المساقات لا يخزن أي بيانات شخصية';
