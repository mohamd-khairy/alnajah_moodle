...
/**
 * Strings for component 'hotquestion', language 'ar', version '3.10'.
 *
 * @package     hotquestion
 * @category    string
...
$string['eventaddquestion'] = 'سؤال تمت إضافته';
...
$string['inputquestionlabel_help'] = 'قم بتغيير تسمية عمود الأسئلة ليلائم بشكل أفضل الغاية من استعمال هذا النشاط.';
$string['invalidquestion'] = 'الأسئلة الفارغة يتم تجاهلها.';
$string['noquestions'] = 'لا إدخالات بعد.';
